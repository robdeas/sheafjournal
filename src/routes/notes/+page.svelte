...
<div class="px-10 py-10 max-w-4xl">
    <div class="mb-8 flex items-end justify-between">
        <div>
            <h1 class="font-display font-light text-4xl text-ink-100 mb-2">Notes</h1>
            <p class="text-ink-400 text-sm">Project notes, client work, reference material.</p>
        </div>
        <button

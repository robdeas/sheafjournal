...
<script lang="ts">
    ...
    import SectionBrowser from '$lib/components/SectionBrowser.svelte';
    import { page } from '$app/state';

    let section = $derived(page.params.section ?? null);
    let filename = $derived(page.params.filename ?? null);
</script>

<SectionBrowser root="Knowledge" {section} {filename} />